 ...
 * =================================================================== */
const WORKER_CONFIG = {
  ALBUM_NAME: "臺北台",                   // 兌換信件的專輯名
  CODE_PREFIX: "TPT1",                    // 兌換碼前綴（SKY1-XXXX-XXXX）
  BASIC_LABEL: "數位專輯",
  ...
  DELUXE_AMOUNT_THRESHOLD: 34900,  // 價位 299/399 → 29900/39900 → 中間值
  ...
  PROTECTED_FILES: new Set([]),  // 臺北台全曲開放試聽，無付費串流曲
  ...
  DEMO_CODES: {
    "TPT1DEMO": { email: "anthonywen0693@gmail.com", product: "299" },
  },
};
